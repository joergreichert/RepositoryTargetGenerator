...
class ContentJarParser extends ContentParser {
	...
	new(String url) throws SAXException, IOException, URISyntaxException {
	...
	def Map<String, Long> getTimestamps(String url, Map<String, Long> localMap) throws IOException, URISyntaxException {
	...
	def List<String> getContents(String url, List<String> localContents) throws SAXException, IOException, URISyntaxException {
		var contentFileName = "content"
	...
	def parse(String compositeContent, String parentLocation, List<String> localContents) throws SAXException, IOException, URISyntaxException {
	...
	def getJarContent(String url, String contentFileName) throws IOException {
	...
	def getXmlContent(String url, String contentFileName) throws URISyntaxException, IOException {
	...
	def lastModifiedXmlUrl(String url, String contentFileName) throws IOException, URISyntaxException {
		lastModified(url, contentFileName, "xml")
	}

	def lastModifiedJarUrl(String url, String contentFileName) throws IOException, URISyntaxException {
		lastModified(url, contentFileName, "jar")
	}

	def existsXmlUrl(String url, String contentFileName) throws IOException, URISyntaxException {
		existsUrl(url, contentFileName, "xml")
	}

	def existsJarUrl(String url, String contentFileName) throws IOException, URISyntaxException {
		existsUrl(url, contentFileName, "jar")
	}

	def boolean existsUrl(String url, String contentFileName, String fileExt) throws IOException, URISyntaxException {
		url.lastModified(contentFileName, fileExt) > -1
	}

	def long lastModified(String url, String contentFileName, String fileExt) throws IOException , URISyntaxException {
	...
	def private dispatch existsUrl(HttpURLConnection contentCon) throws IOException {
	...
	def parseVersionForId(String id, List<(String)=>boolean> filters) throws SAXException, IOException {
		getParsedContent(id, filters).version
	}

	def parseVersionsForId(String id, List<(String)=>boolean> filters) throws SAXException, IOException {
		getParsedContent(id, filters).versions
	}

	def private getParsedContent(String id, List<(String)=>boolean> filters) throws SAXException, IOException {
	...
	def parseLocations(String content, String location) throws SAXException, IOException {
