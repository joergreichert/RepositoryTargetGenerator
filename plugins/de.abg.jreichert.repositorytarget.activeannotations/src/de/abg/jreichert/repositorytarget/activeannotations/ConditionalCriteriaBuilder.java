...
import de.abg.jreichert.repositorytarget.activeannotations.ConditionalCriteria.Operator;

//copied and adapted from https://github.com/sculptor/base/blob/master/sculptor-framework/sculptor-framework-main/src/main/java/org/fornax/cartridges/sculptor/framework/accessapi/ConditionalCriteriaBuilder.java
public class ConditionalCriteriaBuilder<T> {
    ...
    public class RootBuilderImpl implements ConditionRoot<T>, OrderBy<T>, Selection<T>, GroupBy<T> {
      ...
      public List<ConditionalCriteria> build() {
        ...
        public ConditionIPropertyLiteral<T> withProperty(IPropertyLiteral<T> property) {
        ...
        public OrderBy<T> orderBy(IPropertyLiteral<T> property) {
       ...
       public ConditionRoot<T> distinctRoot() {
		...
		@Override
        public GroupBy<T> groupBy(IPropertyLiteral<T> property) {
            pushCriteria(ConditionalCriteria.groupBy(property));
            return this;
        }

		@Override
		public Selection<T> select(IPropertyLiteral<T> property) {
            pushCriteria(ConditionalCriteria.select(property));
			return this;
		}

		@Override
		public Selection<T> select(IPropertyLiteral<T> property, String alias) {
      ...
      private void pushCriteria(ConditionalCriteria criteria) {
        ...
        private class PropBuilderImpl implements ConditionIPropertyLiteral<T>, Between<T> {
            IPropertyLiteral<?> baseProp;
            Object value1;

            PropBuilderImpl(IPropertyLiteral<?> name) {
                this.baseProp = name;
            }
            ...
            public ConditionRoot<T> eq(IPropertyLiteral<T> property) {
            ...
            public ConditionRoot<T> lessThan(IPropertyLiteral<T> property) {
                pushCriteria(ConditionalCriteria.lessThanProperty(baseProp, property));
                return RootBuilderImpl.this;
            }

            public ConditionRoot<T> lessThanOrEqual(IPropertyLiteral<T> property) {
                pushCriteria(ConditionalCriteria.lessThanOrEqualProperty(baseProp, property));
                return RootBuilderImpl.this;
            }

            public ConditionRoot<T> greaterThan(IPropertyLiteral<T> property) {
                pushCriteria(ConditionalCriteria.greatThanProperty(baseProp, property));
                return RootBuilderImpl.this;
            }

            public ConditionRoot<T> greaterThanOrEqual(IPropertyLiteral<T> property) {
    ...
    public interface ConditionRoot<T> {
        ...
        ConditionIPropertyLiteral<T> withProperty(IPropertyLiteral<T> property);
        ConditionRoot<T> and();
        ConditionRoot<T> or();
        ConditionRoot<T> not();
        Selection<T> select(IPropertyLiteral<T> property);
        Selection<T> select(IPropertyLiteral<T> property, String alias);
        OrderBy<T> orderBy(IPropertyLiteral<T> property);
        GroupBy<T> groupBy(IPropertyLiteral<T> property);
    ...
    public interface ConditionIPropertyLiteral<T> {
        ConditionRoot<T> eq(Object value);
        ConditionRoot<T> ignoreCaseEq(Object value);
        ConditionRoot<T> eq(IPropertyLiteral<T> property);
        ...
        ConditionRoot<T> lessThan(IPropertyLiteral<T> property);
        ConditionRoot<T> lessThanOrEqual(IPropertyLiteral<T> property);
        ConditionRoot<T> greaterThan(IPropertyLiteral<T> property);
        ConditionRoot<T> greaterThanOrEqual(IPropertyLiteral<T> property);
